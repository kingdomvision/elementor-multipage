<?php
/**
 *bizex Bootstrap Navwalker
 *
 * @packagebizex-Bootstrap-Navwalker
 *
 */

// Check if Class Exists.
if ( ! class_exists( 'Bizex_Bootstrap_Navwalker' ) ) {
	/**
	 * Bizex_Bootstrap_Navwalker class.
	 */
	class Bizex_Bootstrap_Navwalker extends Walker_Nav_Menu {
		...
		public static function fallback( $args ) {
			...
			$fallback_output .= '<li class="nav-item"><a href="' . esc_url( admin_url( 'nav-menus.php' ) ) . '" class="nav-link" title="' . esc_attr__( 'Add a menu', 'bizex' ) . '">' . esc_html__( 'Add a menu', 'bizex' ) . '</a></li>';
			$fallback_output .= '</ul>';
